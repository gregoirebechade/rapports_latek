...
\fancyhead[R]{\includegraphics[width=1.5cm]{logo_x.png}} % Image en en-tête droite
...
\input{sections/introduction} % intro + analyse de la litérature + objective du stage 
