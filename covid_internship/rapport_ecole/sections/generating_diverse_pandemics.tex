\section{Generating diverse pandemics}
...
Let $Y_1$ ,  $Y_2 \in \mathbb{R}^n$  be two time series of $n$ days representing the number of hospitalized in two pandemics, and $Y'$ and $Y''$ the first and second derivatives pf $Y$.  \\[0.2cm]
