...
In order to compare the performance of the models at different point of the pandemic, we classified the points in six categories : \textit{stable, increase, big increase, decrease, big decrease}.
...
Indeed, as the ensemble models were tarined on a part of the pandemics, they can't be evaluated on the whole set of outbreaks. 
