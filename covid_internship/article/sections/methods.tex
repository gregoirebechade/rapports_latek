...
In this study, we define a model $\mathcal{h}_{\theta , \mathcal{D}}$ as a function $\mathcal{h}$  defined on $ \mathbb{N}$, with parameters $\theta$ and trained on the data $\mathcal{D}$. 
