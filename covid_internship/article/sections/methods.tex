...
To create the most diverse set possible, we also created 4 different mobilities reports \ref*{fig:mobilities.png}, corresponding to constant mobility, annual variations, lockdown scenario and the reports from Vasträffik from \cite{gerlee2021predicting}. 
