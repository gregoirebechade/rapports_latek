...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
      ...
      \caption{Rankings for 7-days ahead predictions for Sweden TOCHANGE}
      \label{fig:sousfig1}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.45\textwidth}
      ...
      \caption{Rankings for 14-days ahead predictions for Sweden TOCHANGE}
      \label{fig:sousfig2}
    \end{subfigure}
